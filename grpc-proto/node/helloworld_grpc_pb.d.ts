...
interface IGreeterService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  sayHelloStreamReply: grpc.MethodDefinition<helloworld_pb.HelloRequest, helloworld_pb.HelloReply>;
}
...
export class GreeterClient extends grpc.Client {
  ...
  sayHelloStreamReply(argument: helloworld_pb.HelloRequest, metadataOrOptions?: grpc.Metadata | grpc.CallOptions | null): grpc.ClientReadableStream<helloworld_pb.HelloReply>;
  sayHelloStreamReply(argument: helloworld_pb.HelloRequest, metadata?: grpc.Metadata | null, options?: grpc.CallOptions | null): grpc.ClientReadableStream<helloworld_pb.HelloReply>;
}
